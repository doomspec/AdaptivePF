...
if __name__ == '__main__':
    root_path = adaptive_pf_output
    status_path = adaptive_pf_output + "/h4/H4_0.05_01-07-09h24m00s"

    plt = get_standard_plt()

    fig, axs = init_subplots(plt, ncols=3, nrows=2, fig_width=10, wid_high_ratio=0.57,
                             more_options={"auto_title": True})
